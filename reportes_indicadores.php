<?php
	...
	$title			= $array_lang['reportes_indicadores'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['reportes_indicadores'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['reportes_indicadores'][$idioma];?></li>
                                </ul>
                ...
                <div class="seccion">
                    <div class="margen margen_gde">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col">
                                <h1 class="mayus"><?=$array_lang['reportes_indicadores'][$idioma];?></h1>  
                            </div>
                        </div>
                        <div class="renglon iguales padding-x padding-y align-center" data-w="600">
                            ...
                            <div class="col col340G align-justify">
                            	...
                            	<div class="renglon padding-x padding-y0">
                                	<div class="col" id="download_data" data-url="<?=$urlSitio.$url_lang.slugify($array_lang['revision'][$idioma]);?>">
                                    	<p>
	                                        <a href="#" class="boton small" id="btn_descarga">Descargar reporte</a> |
                                            <a data-href="<?=$urlSitio;?>data/reportes.php?t=<?=$tokenPublic;?>&idtipo=indicadores" href="#" class="boton small" id="btn_descarga_full">Descargar reporte completo</a>
                                        </p>
                                    </div>
                                    <div class="col">
