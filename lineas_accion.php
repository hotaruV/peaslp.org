<?php
	...
	$title			= $array_lang['lineas_accion'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['lineas_accion'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
	...
	<body>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['lineas_accion'][$idioma];?></li>
                                </ul>
                ...
                <div class="seccion">
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col">
                                <h1 class="mayus"><?=$array_lang['lineas_accion'][$idioma];?></h1>  
                            </div>
                        </div>
                        <div class="renglon iguales padding-x padding-y align-center" data-w="600">
                            ...
                            <div class="col col340G align-justify">
                            	<ul class="nav int">
                                	<li><a href="#" data-view="datos">Líneas de acción</a></li>
                                    <li><a href="#" data-view="forma">Nueva línea de acción</a></li>
                                </ul> 
                                <div class="view formulario align-left" data-action="<?=$urlSitio.$url_lang;?>" id="form_contacto">
                                    <div class="renglon padding-x0 padding-y0">
                                    	<div class="col">
                                            <h3 class="margin-yb"><span>Nueva línea de acción</span></h3>  
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> #:</div>
                                                <div class="r">
                                                    <input type="text" id="input_identificador" maxlength="10"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Línea de acción:</div>
                                                <div class="r">
                                                    <!--<input type="text" id="input_linea_de_accion" maxlength="500"/>-->
                                                    <textarea id="input_linea_de_accion"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Actores responsables:</div>
                                                <div class="r">
                                                    <input type="text" name="ids" id="input_actores" placeholder="" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="item" data-obligatorio="false">
                                                <div class="p"> Anexo ATA</div>
                                                <div class="r">
                                                    <input type="text" name="ids" id="input_anexo_ata" data-type="numero" placeholder="" value="">
                                                </div>
                                            </div>
                                        </div>
	    ...
	    <script>
			$(document).ready(function(){
				linea_de_accion_ready();
			});
			$(window).on('load', function(){
				linea_de_accion_load();
			});
