<?php
	...
	$title			= $array_lang['captura_lineas'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['captura_lineas'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['captura_lineas'][$idioma];?></li>
                                </ul>
                    ...
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col align-justify" >
                                <h1 class="mayus align-center"><?=$array_lang['captura_lineas'][$idioma];?></h1>  
                           	</div>
						</div>
                            ...
                            <div class="col col340G align-justify">
                                ...
                                <div class="view formulario align-left" id="form_captura">
                                    <div class="renglon padding-x padding-y0 no_imprimirs">
                                        ...
                                        <div class="col">
                                            <div class="renglon iguales padding-x2 padding-y0">
                                                <div class="col col2">
