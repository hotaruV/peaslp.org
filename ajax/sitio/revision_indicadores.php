	...
	if ($error_post == 0) {
		...
		if(empty($error)){
			...
			if(is_array($periodo) and !empty($periodo)){ 
				...
				if($periodo_indicadores_data["actor_catalogo"] == NULL){
					$periodo_indicadores_data["actor_catalogo"] = "null";
				}
				if($periodo_indicadores_data["actor_elemento"] == NULL){
					$periodo_indicadores_data["actor_elemento"] = "null";
				}
					...
					" 
						...
						AND ( 
							...
							OR (
								...
								JSON_UNQUOTE(JSON_EXTRACT(usuario_data, '$.actor_catalogo')) = \"".$periodo_indicadores_data["actor_catalogo"]."\" 
							)
						)
						AND (
							(
							...
							OR (
								...
								JSON_UNQUOTE(JSON_EXTRACT(usuario_data, '$.actor_elemento')) = \"".$periodo_indicadores_data["actor_elemento"]."\"
							)
						)
						AND activo = 1 
					",
					...
					" 
						...
						AND (
							...
							OR (
								...
								JSON_UNQUOTE(JSON_EXTRACT(captura_data, '$.actor_catalogo')) = \"".$periodo_indicadores_data["actor_catalogo"]."\"
							)
						)
						AND (
							(
							...
							OR (
								...
								JSON_UNQUOTE(JSON_EXTRACT(captura_data, '$.actor_elemento')) = \"".$periodo_indicadores_data["actor_elemento"]."\"
							)
						)
				...
				$revision = $revisionClass->getTablaJSONUnique(
					" 
						...
						AND JSON_UNQUOTE(JSON_EXTRACT(revision_data, '$.actor')) = ".$periodo_indicadores_data["actor"]."
						AND JSON_UNQUOTE(JSON_EXTRACT(revision_data, '$.actor_municipio')) = \"".$periodo_indicadores_data["actor_municipio"]."\"
						AND (
							(
							...
							OR (
								...
								JSON_UNQUOTE(JSON_EXTRACT(revision_data, '$.actor_catalogo')) = \"".$periodo_indicadores_data["actor_catalogo"]."\"
							)
						)
						AND (
							(
							...
							OR (
								...
								JSON_UNQUOTE(JSON_EXTRACT(revision_data, '$.actor_elemento')) = \"".$periodo_indicadores_data["actor_elemento"]."\"
							)
						)
						AND JSON_UNQUOTE(JSON_EXTRACT(revision_data, '$.periodo')) = ".$periodo_indicadores_data["periodo"]."
						AND activo = 1 
					"
				);
