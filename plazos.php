<?php
	...
	$title			= $array_lang['plazos'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['plazos'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['plazos'][$idioma];?></li>
                                </ul>
                    ...
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col align-justify" >
                                <h1 class="mayus align-center"><?=$array_lang['plazos'][$idioma];?></h1>  
                           	</div>
						</div>
                        <div class="renglon iguales padding-x padding-y align-center" data-w="840">
                            ...
                            <div class="col col340G align-justify">
                                ...
                                <ul class="nav int">
                                    <li><a href="#" data-view="datos">Plazos</a></li>
                                    <li><a href="#" data-view="forma">Nuevo plazo</a></li>
                                </ul> 
                                ...
                                <div class="view formulario align-left" data-action="<?=$urlSitio.$url_lang;?>" id="form_contacto">
                                    <div class="renglon padding-x0 padding-y0">
                                    	<div class="col">
                                            <h3 class="margin-yb"><span>Nuevo plazo</span></h3>  
                                        </div>
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Plazo (temporalidad):</div>
                                                <div class="r">
                                                    <input type="text" id="input_plazo" maxlength="250"/>
                                                </div>
                                            </div>
                                        </div>	
                                    </div>
