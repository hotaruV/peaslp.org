<?php
	...
	$title			= $array_lang['instituciones'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['instituciones'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['instituciones'][$idioma];?></li>
                                </ul>
                    ...
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col align-justify" >
                                <h1 class="mayus align-center"><?=$array_lang['instituciones'][$idioma];?></h1>  
                           	</div>
						</div>
                        <div class="renglon iguales padding-x padding-y align-center" data-w="600">
                            ...
                            <div class="col col340G align-justify">
                                ...
                                <ul class="nav int">
                                    <li><a href="#" data-view="datos">Instituciones coordinadoras</a></li>
                                    <li><a href="#" data-view="forma">Nueva institución coordinadora</a></li>
                                </ul> 
                                ...
                                <div class="view formulario align-left" data-action="<?=$urlSitio.$url_lang;?>" id="form_contacto">
                                    <div class="renglon padding-x0 padding-y0">
                                    	<div class="col">
                                            <h3 class="margin-yb"><span>Nueva institución coordinadora</span></h3>  
                                        </div>
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Institución coordinadora:</div>
                                                <div class="r">
                                                    <input type="text" id="input_institucion" maxlength="250"/>
                                                </div>
                                            </div>
                                        </div>	
                                        <div class="col">
