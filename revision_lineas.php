<?php
	...
	if(isset($_GET) and isset($_GET['a']) and isset($_GET['p'])){
		...
		if(isset($_GET['ad'])){
			$plazo = intval($_GET['ad']);
		}
	}
	
	require_once "part/gnl/headers.php";
	$title			= $array_lang['revision_lineas'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['revision_lineas'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['revision_lineas'][$idioma];?></li>
                                </ul>
                    ...
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col align-justify" >
                                <h1 class="mayus align-center"><?=$array_lang['revision_lineas'][$idioma];?></h1>  
                           	</div>
						</div>
                                ...
                                <div class="view formulario align-left" id="form_revision">
                                    ...
                                    <div class="renglon iguales padding-x padding-y0 no_imprimirs">
                                        ...
                                        <div class="col col2">
                                            <div class="item" data-obligatorio="false">
                                                ...
                                                <div class="r">
                                                    <select id="input_filtro_plazos" rel="<?=$plazo;?>">
                                                        <option value="">Seleccione</option>
                                                        <option value="-1">Todos los plazos</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php if(in_array($usuario_perfil, array(1))){ ?>
                                        <div class="renglon padding-x padding-y no_imprimirs" id="q_captura_todo">
                                            <div class="col">
                                                <div>												
                                                    <p><a href="#" class="rojo" id="btn_eliminar_todo_lineas">Eliminar toda captura del actor en el periodo seleccionado.</a></p>
                                                </div>
                                            </div>
                                        </div>
									<?php } ?> 
                                        ...
                                        <div class="col">
                                            ...
                                            <div style="padding-left:30px; padding-bottom:0.5rem;">
                                            	<div id="btn_filtro_aprobados" class="btn_filtro" data-value="1" data-tipo="aprobado">
                                                	Aprobadas: <strong><span id="estatus_aprobados"></span></strong>
                                                </div>
                                                <div id="btn_filtro_rechazados" class="btn_filtro" data-value="2" data-tipo="aprobado">
	                                                Rechazadas: <strong><span id="estatus_rechazados"></span></strong>
                                                </div>
                                            ...
                                            <div style="padding-left:30px; padding-bottom:0.5rem;">
                                            	...
                                            	<div id="btn_filtro_no_iniciados" class="btn_filtro" data-value="1" data-tipo="estatus">
                                                	No se ha iniciado: <strong><span id="cumplio_1"></span></strong>
                                                </div>
                                                <div id="btn_filtro_planeacion" class="btn_filtro" data-value="2" data-tipo="estatus">
	                                                En planeación: <strong><span id="cumplio_2"></span></strong>
                                                </div>
                                                <div id="btn_filtro_proceso" class="btn_filtro" data-value="3" data-tipo="estatus">
	                                                En proceso: <strong><span id="cumplio_3"></span></strong>
                                                </div>
                                                <div id="btn_filtro_terminados" class="btn_filtro" data-value="4" data-tipo="estatus">
	                                                Finalizado: <strong><span id="cumplio_4"></span></strong>
                                                </div>
                                            </div>
                                    ...
                                    <div class="renglon padding-x padding-y0 ">
                                        <div class="col no_imprimirs" id="filtros" style="">
                                         	<p>
