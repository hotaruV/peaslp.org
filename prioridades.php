<?php
	...
	$title			= $array_lang['prioridades'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['prioridades'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['prioridades'][$idioma];?></li>
                                </ul>
                ...
                <div class="seccion">
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col">
                                <h1 class="mayus"><?=$array_lang['prioridades'][$idioma];?></h1>  
                            </div>
                        </div>
                        <div class="renglon iguales padding-x padding-y align-center" data-w="600">
                            ...
                            <div class="col col340G align-justify">
                            	<ul class="nav int">
                                    <li><a href="#" data-view="datos">Prioridades</a></li>
                                    <li><a href="#" data-view="forma">Nueva prioridad</a></li>
                                </ul>  
                                ...
                                <div class="view formulario align-left" data-action="<?=$urlSitio.$url_lang;?>" id="form_contacto">
                                    <div class="renglon padding-x0 padding-y0">
                                    	<div class="col">
                                            <h3 class="margin-yb"><span>Nueva prioridad</span></h3>  
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Plazo (temporalidad):</div>
                                                <div class="r">
                                                    <select id="input_plazo">
                                                        <option value="">Seleccione</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                ...
                                                <div class="r">
                                                	<input type="text" id="input_prioridad" maxlength="750"/>
                                                </div>
                                            </div>
                                        </div>
