<?php
	...
	$title			= $array_lang['actores'][$idioma].' | '.$title_site;
	$description	= "";
	$url			= $url_lang.slugify($array_lang['actores'][$idioma]);
	$keywords 		= "";
	$robots 		= "all";
	$imagen 		= "img/".$img_site;
?>
                       ...
                       <div class="renglon padding-x padding-y align-left">
                            <div class="col">
                                ...
                                <ul class="nav">
                                    ...
                                    <li><?=$array_lang['actores'][$idioma];?></li>
                                </ul>
                    ...
                    <div class="margen">
                        <div class="renglon padding-x padding-y align-center lineaB">
                            <div class="col align-justify" >
                                <h1 class="mayus align-center"><?=$array_lang['actores'][$idioma];?></h1>  
                           	</div>
						</div>
                        <div class="renglon iguales padding-x padding-y align-center" data-w="600">
                            ...
                            <div class="col col340G align-justify">
                                ...
                                <ul class="nav int">
                                    <li><a href="#" data-view="datos">Actores responsables</a></li>
                                    <li><a href="#" data-view="forma">Nuevo actor responsable</a></li>
                                </ul> 
                                ...
                                <div class="view formulario align-left" data-action="<?=$urlSitio.$url_lang;?>" id="form_contacto">
                                    <div class="renglon padding-x0 padding-y0">
                                    	<div class="col">
                                            <h3 class="margin-yb"><span>Nuevo actor responsable</span></h3>  
                                        </div>
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Actor responsable:</div>
                                                <div class="r">
                                                    <input type="text" id="input_actor" maxlength="250"/>
                                                </div>
                                            </div>
                                        </div>	
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Siglas:</div>
                                                <div class="r">
                                                    <input type="text" id="input_siglas" maxlength="250"/>
                                                </div>
                                            </div>
                                        </div>	
                                        <div class="col" style="display:none;">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Municipios </div>
                                                <div class="r">
                                                    <label class="switcher">
                                                        <div class="switch"></div>
                                                        <input type="checkbox" data-type="switch" value="1" name="input_municipios" class="auto"> 
                                        ...
                                        <div class="col">
                                            <div class="item" data-obligatorio="true">
                                                <div class="p"> Catálogos </div>
                                                <div class="r">
                                                    <label class="switcher">
                                                        <div class="switch"></div>
                                                        <input type="checkbox" data-type="switch" value="1" name="input_catalogos" class="auto"> 
                                       	...
                                       	<div class="col">
                                        	<div class="item" data-obligatorio="false" id="div_catalogo_pertenece">
                                                <div class="p"> Catálogo al que pertenece el actor responsable:</div>
                                                <div class="r">
                                                    <select id="input_catalogo_pertenece">
